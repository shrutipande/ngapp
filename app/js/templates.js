define(['angular', 'app'], function(angular, app) { app.run(['$templateCache', function($templateCache) {  'use strict';
  ...
  $templateCache.put('partials/login.html',
    ...
    "\t\t\t\t<a class=\"signup-fb\" ng-click=\"authenticate('facebook')\"><small><img src=\"images/facebook_alt.png\" width=\"8\" height=\"17\" alt=\"\" title=\"\"></small><span>Log In with Facebook</span></a>\n" +
    "\t\t\t</div>\n" +
    "\t\t\t<div class=\"col-xs-6 nopadding socialMedia\">\n" +
    "\t\t\t\t<a class=\"signup-g\" ng-click=\"authenticate('google')\"><small><img src=\"images/googlw_Plus.png\" width=\"26\" height=\"16\" alt=\"\" title=\"\"></small><span>Log In with Google</span></a>\n" +
    "\t\t\t</div>\n" +
